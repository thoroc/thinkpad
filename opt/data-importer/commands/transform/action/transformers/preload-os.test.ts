...
import { Languages, PreloadedOS, toLanguages, toPreloadedOS } from './preload-os.ts';
...
describe('toLanguages', () => {
  const testCases: Array<{ input: string; expected: Languages }> = [
    ...
    {
      input: 'English',
      expected: { values: ['English'] },
    },
    // Japanese
    {
      input: 'Japanese',
      expected: { values: ['Japanese'] },
    },
    // Arabic / English
    {
      input: 'Arabic / English',
      expected: { values: ['Arabic', 'English'] },
    },
    // Croatian / English / Slovenian
    {
      input: 'Croatian / English / Slovenian',
      expected: { values: ['Croatian', 'English', 'Slovenian'] },
    },
    // Czech / English
    {
      input: 'Czech / English',
      expected: { values: ['Czech', 'English'] },
    },
    // French
    {
      input: 'French',
      expected: { values: ['French'] },
    },
    // German
    {
      input: 'German',
      expected: { values: ['German'] },
    },
    // Greek / English
    {
      input: 'Greek / English',
      expected: { values: ['Greek', 'English'] },
    },
    // Hebrew / English
    {
      input: 'Hebrew / English',
      expected: { values: ['Hebrew', 'English'] },
    },
    // Hungarian / English
    {
      input: 'Hungarian / English',
      expected: { values: ['Hungarian', 'English'] },
    },
    // Nordic (DK/FI/SV/NO/EN)
    {
      input: 'Nordic (DK/FI/SV/NO/EN)',
      expected: {
        values: ['Danish', 'Finnish', 'Swedish', 'Norwegian', 'English'],
        family: 'Nordic',
      },
    },
    // Polish / English
    {
      ...
      expected: { values: ['Polish', 'English'] },
    },
    // Portuguese (Brazil)
    {
      input: 'Portuguese (Brazil)',
      expected: { values: ['Portuguese (Brazil)'] },
    },
    // Portuguese / English
    {
      input: 'Portuguese / English',
      expected: { values: ['Portuguese', 'English'] },
    },
    // Romanian / English
    {
      input: 'Romanian / English',
      expected: { values: ['Romanian', 'English'] },
    },
    // Russian
    {
      input: 'Russian',
      expected: { values: ['Russian'] },
    },
    // Serbian / English
    {
      input: 'Serbian / English',
      expected: { values: ['Serbian', 'English'] },
    },
    // Slovak / English
    {
      input: 'Slovak / English',
      expected: { values: ['Slovak', 'English'] },
    },
    // Spanish
    {
      input: 'Spanish',
      expected: { values: ['Spanish'] },
    },
    // Turkish / English
    {
      input: 'Turkish / English',
      expected: { values: ['Turkish', 'English'] },
    },
    // WE (EN/FR/DE/NL/IT)
    {
      input: 'WE (EN/FR/DE/NL/IT)',
      expected: {
        values: ['English', 'French', 'German', 'Dutch', 'Italian'],
