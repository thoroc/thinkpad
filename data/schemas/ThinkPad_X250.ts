...
//
//   const thinkPadX250 = Convert.toThinkPadX250(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface ThinkPadX250 {
    Model:                string;
    Product:              Product;
    Region:               Region;
...
export class Convert {
    public static toThinkPadX250(json: string): ThinkPadX250[] {
        return cast(JSON.parse(json), a(r("ThinkPadX250")));
    }

    public static thinkPadX250ToJson(value: ThinkPadX250[]): string {
        return JSON.stringify(uncast(value, a(r("ThinkPadX250"))), null, 2);
    }
}
