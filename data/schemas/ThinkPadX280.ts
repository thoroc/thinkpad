...
export enum CaseMaterial {
  CarbonFiberTopMagnesiumAluminumBottom =
    "Carbon Fiber (Top), Magnesium / Aluminum (Bottom)",
  GlassFiberTopMagnesiumAluminumBottom =
...
export enum Display {
  The125FHD1920X1080WVA300NitsAntiGlare =
